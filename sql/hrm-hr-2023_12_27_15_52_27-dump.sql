...
CREATE TABLE `bonus` (
  ...
  `eID` varchar(12) DEFAULT NULL COMMENT '档案编号,uID',
  PRIMARY KEY (`bID`)
...
INSERT INTO `bonus` VALUES (1,1000.00,0.00,'202301020302'),(2,20000.00,0.00,'202301020303'),(3,0.00,-1000.00,'202301020304');
...
INSERT INTO `employee` VALUES ('202301020301','10','20','N/A','测试类','测试职位','测试职称','test','男性',11,'test@gmail.com','0763','12345678901','123456','测试地址','513400','2023-12-23','湛江','头像url','441882202311111111','123456789','中国','瑶族','无','群众','本科','软件工程','10','建设银行','11111111','唱跳rap篮球','唱跳rap篮球','简介测试','家庭关系测试','备注','管理员','2023-12-23 00:00:00',0),('202301020302','10','20','30','测试类','测试职位','测试职称','test','男性',11,'test@gmail.com','0763','12345678901','123456','测试地址','513400','2023-12-23','湛江','头像url','441882202311111111','123456789','中国','瑶族','无','群众','本科','软件工程','1','建设银行','11111111','唱跳rap篮球','唱跳rap篮球','简介测试','家庭关系测试','备注','sakta','2023-12-25 03:51:10',1),('202301020303','10','20','30','测试类','测试职位','测试职称','test','男性',11,'test@gmail.com','0763','12345678901','123456','测试地址','513400','2023-12-23','湛江','头像url','441882202311111111','123456789','中国','瑶族','无','群众','本科','软件工程','1','建设银行','11111111','唱跳rap篮球','唱跳rap篮球','简介测试','家庭关系测试','备注','sakta','2023-12-25 03:51:10',1),('202301020304','10','20','40','测试类','测试职位','测试职称','test','男性',11,'test@gmail.com','0763','12345678901','123456','测试地址','513400','2023-12-23','湛江','头像url','441882202311111111','123456789','中国','瑶族','无','群众','本科','软件工程','1','建设银行','11111111','唱跳rap篮球','唱跳rap篮球','简介测试','家庭关系测试','备注','sakta','2023-12-25 03:51:10',1);
...
INSERT INTO `institution` VALUES ('10','一级机构',1,NULL),('20','二级机构',2,'10'),('30','三级机构',3,'20'),('40','三级机构2',3,'20');
...
CREATE TABLE `payroll` (
  `pID` int NOT NULL AUTO_INCREMENT COMMENT '薪酬发放单编号',
  ...
  `pCount` int DEFAULT NULL COMMENT '人数',
  `pSalarySum` decimal(10,2) DEFAULT NULL COMMENT '基本薪资总额',
  `pL3InstID` int DEFAULT NULL COMMENT '三级机构编号',
...
INSERT INTO `payroll` VALUES (1,'一级机构','二级机构','三级机构',2,10000.00,2,1,'1',' 和和v韩国'),(2,'一级机构','二级机构','三级机构',2,10000.00,2,0,'1',NULL);
...
INSERT INTO `position` VALUES (2,'测试职位','测试类');
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `salary` (
  `sID` int NOT NULL AUTO_INCREMENT COMMENT '标准编号',
...
INSERT INTO `salary` VALUES (1,'T1',5000.00,10.00,10.00,10.00,400.00,103.00,25.00,400.00,'123456','2023-12-27 01:09:21','张三','1',1,NULL),(2,'T1',5000.00,10.00,10.00,10.00,400.00,103.00,25.00,400.00,'123456','2023-12-27 01:40:10','张三',NULL,0,NULL);
...
-- Dump completed on 2023-12-27 15:52:27
